...
There still seems to be a problem, maybe you could take a look?
...
Fails for me with `Error in glm.fitter(x = X, y = Y, w = w, etastart = eta, offset = offset, : NA/NaN/Inf in 'x'`. 
