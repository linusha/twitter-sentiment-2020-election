...
```{r}
# all
table(tweet_data$ct_sentiment)
table(tweet_data$ct_polarity)
# famous
table(famous_tweet_data$ct_sentiment)
table(famous_tweet_data$ct_polarity)
# not famous
table(not_famous_tweet_data$ct_sentiment)
table(not_famous_tweet_data$ct_polarity)
```
...
```{r}
# all
table(tweet_data$cleanLIWC_i)
table(tweet_data$cleanLIWC_we)
table(tweet_data$cleanLIWC_they)
# famous
table(famous_tweet_data$cleanLIWC_i)
table(famous_tweet_data$cleanLIWC_we)
table(famous_tweet_data$cleanLIWC_they)
# not famous
table(not_famous_tweet_data$cleanLIWC_i)
table(not_famous_tweet_data$cleanLIWC_we)
table(not_famous_tweet_data$cleanLIWC_they)
```
...
```{r}
# all
table(tweet_data$cleanLIWC_cause)
table(tweet_data$cleanLIWC_certain)
table(tweet_data$cleanLIWC_insight)
table(tweet_data$cleanLIWC_discrep)
# famous
table(famous_tweet_data$cleanLIWC_cause)
table(famous_tweet_data$cleanLIWC_certain)
table(famous_tweet_data$cleanLIWC_insight)
table(famous_tweet_data$cleanLIWC_discrep)
# not famous
table(not_famous_tweet_data$cleanLIWC_cause)
table(not_famous_tweet_data$cleanLIWC_certain)
table(not_famous_tweet_data$cleanLIWC_insight)
table(not_famous_tweet_data$cleanLIWC_discrep)
```
...
summary(glm.nb(likes ~ hashtagCount + url + 
               cleanLIWC_WC + user_activity
                ...
                cleanLIWC_i + cleanLIWC_we + cleanLIWC_they + #prosocial
                cleanLIWC_insight + cleanLIWC_cause + cleanLIWC_discrep + cleanLIWC_certain,
                data = not_famous_tweet_data[not_famous_tweet_data$likes > 0,]))
```
