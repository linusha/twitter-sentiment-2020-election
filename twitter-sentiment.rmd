...
nbr_original_tweets <- glm.nb(retweets ~ hashtags + url + log_user_activity + ot_sentiment, data = all_data)
...
nbr_original_tweets <- glm.nb(retweets ~ sentiment + ot_isNegative + log_user_activity + hashtags + url + ot_interactionTerm, data = all_data)
summary(nbr_original_tweets)
rm("nbr_original_tweets")
nbr_clean_tweets <- glm.nb(retweets ~ sentiment + ct_isNegative + log_user_activity + hashtags + url + ct_interactionTerm, data = all_data)
summary(nbr_clean_tweets)
rm("nbr_clean_tweets")
nbr_preprocessed_tweets <- glm.nb(retweets ~ sentiment + pp_isNegative + log_user_activity + hashtags + url + pp_interactionTerm, data = all_data)
summary(nbr_preprocessed_tweets)
rm("nbr_preprocessed_tweets")
nbr_no_emojis_tweets <- glm.nb(retweets ~ sentiment + ne_isNegative + log_user_activity + hashtags + url + ne_interactionTerm, data = all_data)
summary(nbr_no_emojis_tweets)
rm("nbr_no_emojis_tweets")
```
